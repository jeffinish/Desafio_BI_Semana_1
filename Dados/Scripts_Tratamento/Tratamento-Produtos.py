...
produtos = produtos.rename(columns={"preço":"Preço","Código_Produto":"ID Produto","Nome Produto":"Nome do produto"})
produtos = produtos.reindex(["ID Produto","Nome do produto","Preço"],axis=1)
produtos.head()
